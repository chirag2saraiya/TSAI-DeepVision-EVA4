...
S3_BUCKET = os.environ['S3_BUCKET'] if 'S3BUCKET' in os.environ else 'gauravp-car-image-gan-models'
MODEL_PATH = os.environ['MODEL_PATH'] if 'MODEL_PATH' in os.environ else 'Car_Generator.pt'
